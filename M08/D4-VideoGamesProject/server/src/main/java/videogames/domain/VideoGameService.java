...
public class VideoGameService {
    ...
    public VideoGameResult create(VideoGame videoGame) {
    ...
    public VideoGameResult update(VideoGame videoGame) {
        VideoGameResult result = validate(videoGame);
    ...
    public VideoGameResult deleteById(int videoGameId) {
    ...
    private VideoGameResult validate(VideoGame videoGame) {
        VideoGameResult result = new VideoGameResult();
