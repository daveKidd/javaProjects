...
public class VideoGameRepositoryDouble implements VideoGameRepository {
    ...
    public List<VideoGame> findAll() {
        ...
        all.add(new VideoGame(1, "The Last of Us", VideoGameConsole.PS5, new BigDecimal("70.00"),
                LocalDate.parse("2013-06-14"), true));
        all.add(new VideoGame(2, "Overwatch", VideoGameConsole.PC, new BigDecimal("20"),
                LocalDate.parse("2016-05-24"), false));
        all.add(new VideoGame(3, "Resident Evil 4", VideoGameConsole.PC, new BigDecimal("15"),
                LocalDate.parse("2005-01-11"), false));
