...
public class Order {
    ...
    // had to add ArrayUtils in the POM
    public LineItem[] removeItem(int indexPosition) {
        lineItems = ArrayUtils.remove(lineItems, indexPosition);
        return lineItems;
    }
}
