public class Exercise01 {
    ...
    public static void main(String[] args) {
        ...
        Musician lessThanJake = new Musician("Less than Jake", 10);
        System.out.println(lessThanJake.getName());

        Musician homeGrown = new Musician("Home Grown", 10);
        System.out.println(homeGrown.getName());
