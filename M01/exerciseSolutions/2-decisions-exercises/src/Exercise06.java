...
public class Exercise06 {
    ...
    public static void main(String[] args) {
        ...
        if(snorkelerCount % 2 == 0){
            ...
            System.out.println("Snorkelers need to have an even number, so everyone has to shop!");
            shopperCount = snorkelerCount + shopperCount;
            snorkelerCount = 0;
        }
        System.out.println("Snorkelers: " + snorkelerCount);
        System.out.println("Shoppers: " + shopperCount);
    }
}
